...
from medialib.myMediaLib_fp_tools import FpGenerator as fpg

def test_FpGenerator_build_fp_task_param():
	...
	fp = fpg.FpGenerator()
	assert fp.build_fp_task_param(path_list[0]) == {'scenario':'single_image_CUE','params': flac_image_cue_expected}
